    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `${API}/api/accounts/change-password/`,
    ...
    return (
        <div className='min-h-screen flex items-center justify-center m-5'>
            <div className='bg-white p-8 rounded shadow-md max-w-md'>
                <h2 className='text-2xl text-center text-orange-700'>Change Password</h2>
                <hr />
                ...
                <div className="flex items-center border-2 py-2 px-3 m-3 rounded-2xl hover:outline-none hover:ring-2 hover:ring-orange-500">
                    ...
                    <button type="submit" className="block w-full bg-orange-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 hover:bg-orange-700">Change Password</button>
                </form>
            </div>
        </div>
    );
