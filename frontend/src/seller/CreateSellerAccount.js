...
import { createSellerAccounts } from '../features/actions/sellerActions';
import { unwrapResult } from '@reduxjs/toolkit';

const CreateSellerAccountComp = () => {
    ...
    const onSubmit = async (event) => {
        ...
        if (!result.errors) {
            Swal.fire({
                icon: 'success',
                title: 'Seller Account Successfully Created.',
                text: result.msg + " \nSave Note down your vendor id " + result.data.vendor_id,
            });
            setValues({
                ...values,
                shopName: "",
            ...
            <div className='bg-gray-100 h-100 w-3/4 mx-auto bg-blur rounded-lg'>
                <div className="flex justify-center py-10 items-center shadow-lg mx-auto ">
                    <form className="bg-white p-3 rounded-lg" >
                        <h1 className="text-center text-orange-800 font-bold text-2xl mb-5 my-auto">Become a Seller!</h1>
                        <hr />
                        {step ===1 && (
                            <div className='items-center m-10'>
                                <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-5 hover:outline-none hover:ring-2 hover:ring-orange-500">
                                    ...
                                    <input className="pl-2 outline-none border-none"
                                        type="text" name="shopName" id="" placeholder="Shop name"
                                        value={shopName}
                        ...
                        {step === 3 && (
                            ...
                            <div className='m-10'>
                                <p className='text-gray-400 font-italic mb-2'>Enter Address of your shop.**</p>
                                <div className="flex items-center border-2 py-2 px-3 mb-4 rounded-2xl hover:outline-none hover:ring-2 hover:ring-orange-500">
                                    ...
                                    <input className="pl-2 outline-none border-none" type="text"
                                        name="address1" id="" placeholder="Street address / Address 1"
                                        value={address1}
...
export default CreateSellerAccountComp