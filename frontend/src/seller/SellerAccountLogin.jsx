    ...
    return (
        ...
        <div className='min-h-screen flex items-center justify-center m-5'>
            <div className='bg-white p-8 rounded shadow-md max-w-md'>
                <h2 className='text-2xl text-center text-orange-700'>Go To Seller Dashboard</h2>
                <hr />
                <form onSubmit={handleSubmit} className='m-3'>
                    <label htmlFor="email" className='text-gray-400 text-semibold'>Enter your Shop Id </label>
...
export default SellerAccountLogin